        ...
        <div className="space-y-8 animate-fade-in">
            <div className="text-center space-y-4 mb-12">
                ...
                <p className="text-lg text-slate-400 max-w-2xl mx-auto leading-relaxed">
                    This website can parse one or more Character Preset Framework preset JSON files and automatically generate the structure for a standalone Baldur's Gate 3 mod.
                </p>
            </div>
