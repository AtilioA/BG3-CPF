...
---@return string|nil
function VCLoca:GetTranslatedStringFromTemplateUUID(object)
...
---@param object any
---@return string|nil
function VCLoca:GetDisplayName(object)
    local name
...
---@param object any
---@return string|nil
function VCLoca:GetDisplayNameHandle(object)
    local name
...
---@param object any
---@return string|nil---@class HelperLoca: Helper
...
function VCLoca:GetTitleName(object)
    local name
    local entity = VCHelpers.Object:GetEntity(object)
    if entity ~= nil then
        if entity.DisplayName ~= nil then
...
---@param object any
---@return string|nil
function VCLoca:GetTitleNameHandle(object)
    local name
    local entity = VCHelpers.Object:GetEntity(object)
    if entity ~= nil then
        if entity.DisplayName ~= nil then
...
---@param handle string The handle of the localized message to update
---@param dynamicContent string The dynamic content to replace the placeholder with
function VCLoca:UpdateLocalizedMessage(handle, dynamicContent)
    -- Retrieve the current translated string for the given handle
    local currentMessage = Ext.Loca.GetTranslatedString(handle)
...
---@param handle string The handle of the localized message to update
---@vararg string|table Dynamic content values to replace placeholders [1], [2], [3], etc., and optional settings table {updateHandle = false}
function VCLoca:InterpolateLocalizedMessage(handle, ...)
    local currentMessage = Ext.Loca.GetTranslatedString(handle)
    local updatedMessage = currentMessage
